    ...
    function ikeaDimmerV2(config) {
        ...
        if (config.extendedOutput === true) {
            ...
            handler
                ...
                .addOutput(0, "on", "brightness_move_up", "hold", function (msg) { return utils.payloads.createBrightnessMove(msg.action_rate); })
                .addOutput(0, "off", "off", "pressed", utils.payloads.overrides.createStateOverride("OFF"))
                .addOutput(0, "off", "brightness_move_down", "hold", function (msg) { return utils.payloads.createBrightnessMove(-msg.action_rate); })
                .addOutput(0, "stop", "brightness_stop", "released", utils.payloads.createBrightnessMove("stop"))
                .addOutput(0, "move_to", "brightness_move_to_level", "pressed", function (msg) {
