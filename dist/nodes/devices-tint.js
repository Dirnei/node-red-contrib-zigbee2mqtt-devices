...
module.exports = function (RED) {
    ...
    function tintRemote(config) {
        ...
        handler
            ...
            .addOutput(1, "color", "color_wheel", "pressed", function (msg) {
            return bavaria.converter.xyToRgb(msg.action_color.x, msg.action_color.y);
        })
            .addOutput(2, "temperature", "color_temp", "pressed", function (msg) { return utils.payloads.createColorTempStep(getColorTempStep(msg)); })
